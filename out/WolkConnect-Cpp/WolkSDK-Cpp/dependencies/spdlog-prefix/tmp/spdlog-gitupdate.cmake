...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref v1.7.0
  WORKING_DIRECTORY "/workspaces/WolkAbout-task/out/WolkConnect-Cpp/WolkSDK-Cpp/dependencies/spdlog-prefix/src/spdlog"
...
if("${show_ref_output}" MATCHES "refs/remotes/v1.7.0")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v1.7.0")
...
# yet).
execute_process(
  COMMAND "/usr/local/bin/git" rev-list --max-count=1 v1.7.0
  WORKING_DIRECTORY "/workspaces/WolkAbout-task/out/WolkConnect-Cpp/WolkSDK-Cpp/dependencies/spdlog-prefix/src/spdlog"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/workspaces/WolkAbout-task/out/WolkConnect-Cpp/WolkSDK-Cpp/dependencies/spdlog-prefix/src/spdlog/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/workspaces/WolkAbout-task/out/WolkConnect-Cpp/WolkSDK-Cpp/dependencies/spdlog-prefix/src/spdlog/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
